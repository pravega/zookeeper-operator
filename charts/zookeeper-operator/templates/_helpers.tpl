...
openAPIV3Schema:
    ...
    spec:
        ...
        ephemeral:
            ...
            storage At anypoint only one of Persistence or Ephemeral should be
            ...
            emptydirvolumesource:
                ...
                medium should back this directory. SizeLimit specifies Total amount
                of local storage required for this EmptyDir volume.
                properties:
                medium:
    ...
    status:
        ...
        externalClientEndpoint:
            description: ExternalClientEndpoint is the internal client IP and port
            type: string
        internalClientEndpoint:
            description: InternalClientEndpoint is the internal client IP and port
            type: string
        members:
