...
require (
	...
	github.com/q8s-io/iapetos v0.0.0-20210616061926-8d7ac1754e42
...
replace (
	...
	k8s.io/node-api => k8s.io/node-api v0.17.12
	k8s.io/sample-apiserver => k8s.io/sample-apiserver v0.17.12
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.17.12
	k8s.io/sample-controller => k8s.io/sample-controller v0.17.12
)
